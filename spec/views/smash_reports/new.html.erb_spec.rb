...
RSpec.describe "smash_reports/new", type: :view do
  before(:each) do
    assign(:smash_report, SmashReport.new(
  ...
  it "renders new smash_report form" do
    render

    assert_select "form[action=?][method=?]", smash_reports_path, "post" do
