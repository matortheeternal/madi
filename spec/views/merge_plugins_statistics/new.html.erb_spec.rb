...
RSpec.describe "merge_plugins_statistics/new", type: :view do
  before(:each) do
    assign(:merge_plugins_statistic, MergePluginsStatistic.new(
      :user_id => 1,
      :times_run => 1,
      :merges_built => 1,
      :plugins_checked => 1,
  ...
  it "renders new merge_plugins_statistic form" do
    render

    assert_select "form[action=?][method=?]", merge_plugins_statistics_path, "post" do
