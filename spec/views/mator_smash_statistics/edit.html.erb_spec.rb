...
RSpec.describe "mator_smash_statistics/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit mator_smash_statistic form" do
    render

    assert_select "form[action=?][method=?]", mator_smash_statistic_path(@mator_smash_statistic), "post" do
